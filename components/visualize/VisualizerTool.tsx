      ...
      <section className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        {step === "paint" && imageUrl && (
          <div className="space-y-4 pb-28">
            ...
            <div className="fixed inset-x-0 bottom-0 z-40 border-t border-chestnut/10 bg-cream/95 p-4 backdrop-blur-md lg:static lg:border-0 lg:bg-transparent lg:p-0 lg:backdrop-blur-none"
