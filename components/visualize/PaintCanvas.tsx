...
export function PaintCanvas({
  ...
  return (
    <div className="space-y-3">
      <div
        ref={containerRef}
        className="relative w-full overflow-hidden rounded-2xl border border-chestnut/15 bg-chestnut/5"
      >
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          ...
          className={`inline-flex min-h-11 items-center gap-2 rounded-full px-4 text-sm font-semibold touch-manipulation ${
            mode === "paint"
              ? "bg-primary-red text-warm-white"
              : "border border-chestnut/20 bg-white text-chestnut"
          }`}
        >
        ...
        <button
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-full border border-chestnut/20 bg-white px-4 text-sm font-semibold text-chestnut disabled:opacity-40 touch-manipulation"
        >
      ...
      <label className="flex items-center gap-3 text-sm text-chestnut/80">
